...
local player_positions = {
    [1] = {fromPos = Position(31959, 31963, 7), toPos = Position(31930, 31946, 6)},
    [2] = {fromPos = Position(31960, 31963, 7), toPos = Position(31931, 31946, 6)},
    [3] = {fromPos = Position(31961, 31963, 7), toPos = Position(31932, 31947, 6)},
    [4] = {fromPos = Position(31962, 31963, 7), toPos = Position(31933, 31948, 6)}
}

local monsters = {
    [1] = {pos = Position(31944, 31952, 6), name = "Demon"}
}
local quest_range = {fromPos = Position(31939, 31946, 6), toPos = Position(31959, 31953, 6)} 

local exit_position = Position(32215, 32268, 6) -- Position completely outside the quest area

local fireArenaSecond = Action()
...
function fireArenaSecond.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
fireArenaSecond:uid(41384)
fireArenaSecond:register()
