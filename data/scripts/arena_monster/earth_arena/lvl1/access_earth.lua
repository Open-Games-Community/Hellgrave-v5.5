...
local player_positions = {
    [1] = {fromPos = Position(32211, 32274, 6), toPos = Position(31934, 31989, 7)},
    [2] = {fromPos = Position(32212, 32274, 6), toPos = Position(31935, 31989, 7)},
    [3] = {fromPos = Position(32213, 32274, 6), toPos = Position(31936, 31989, 7)},
    [4] = {fromPos = Position(32214, 32274, 6), toPos = Position(31937, 31989, 7)}
}

local monsters = {
    [1] = {pos = Position(31936, 32000, 7), name = "Serpent Spawn"},
    [2] = {pos = Position(31944, 31999, 7), name = "Serpent Spawn"}
}
local quest_range = {fromPos = Position(31931, 31988, 7), toPos = Position(31957, 32011, 7)} 
...
local specs, spec = Game.getSpectators(Position(33919, 31646, 8), false, false, 18, 18, 18, 18) -- Do not change
    for j = 1, #specs do
        spec = specs[j]
        if spec:getName():lower() == 'Serpent Spawn' then
            spec:remove()
        end
    end
end
