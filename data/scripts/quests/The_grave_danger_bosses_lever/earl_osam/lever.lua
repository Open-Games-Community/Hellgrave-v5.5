...
local player_positions = {
    [1] = {fromPos = Position(32405, 31497, 8), toPos = Position(32375, 31496, 8)},
    [2] = {fromPos = Position(32406, 31497, 8), toPos = Position(32376, 31496, 8)},
    [3] = {fromPos = Position(32407, 31497, 8), toPos = Position(32377, 31496, 8)},
    [4] = {fromPos = Position(32408, 31497, 8), toPos = Position(32378, 31496, 8)},
	[5] = {fromPos = Position(32409, 31497, 8), toPos = Position(32379, 31496, 8)}
}

local monsters = {
    [1] = {pos = Position(32377, 31491, 8), name = "Earl Osam"}
}
local quest_range = {fromPos = Position(32373, 31483, 8), toPos = Position(32381, 31498, 8)} -- see image in thread for explanation

local exit_position = Position(32407, 31492, 8) -- Position completely outside the quest area
...
local specs, spec = Game.getSpectators(Position(33919, 31646, 8), false, false, 18, 18, 18, 18)
    for j = 1, #specs do
        spec = specs[j]
        if spec:getName():lower() == 'Earl Osam' then
            spec:remove()
        end
    end
end
