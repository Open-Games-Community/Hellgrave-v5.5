...
local player_positions = {
    [1] = {fromPos = Position(32832, 31847, 8), toPos = Position(32803, 31851, 8)},
    [2] = {fromPos = Position(32833, 31847, 8), toPos = Position(32803, 31852, 8)},
    [3] = {fromPos = Position(32834, 31847, 8), toPos = Position(32803, 31853, 8)},
    [4] = {fromPos = Position(32835, 31847, 8), toPos = Position(32803, 31854, 8)}
}

local monsters = {
    [1] = {pos = Position(32805, 31848, 8), name = "The Unwelcome"}
}
local quest_range = {fromPos = Position(32799, 31843, 8), toPos = Position(32810, 31855, 8)} -- see image in thread for explanation

local exit_position = Position(32838, 31847, 8) -- Position completely outside the quest area
