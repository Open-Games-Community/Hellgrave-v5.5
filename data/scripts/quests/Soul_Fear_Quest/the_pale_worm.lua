...
local player_positions = {
    [1] = {fromPos = Position(32868, 31814, 8), toPos = Position(32901, 31820, 8)},
    [2] = {fromPos = Position(32869, 31814, 8), toPos = Position(32901, 31821, 8)},
    [3] = {fromPos = Position(32870, 31814, 8), toPos = Position(32901, 31822, 8)},
    [4] = {fromPos = Position(32871, 31814, 8), toPos = Position(32901, 31823, 8)}
}

local monsters = {
    [1] = {pos = Position(32901, 31814, 8), name = "The Pale Worm"}
}
local quest_range = {fromPos = Position(32894, 31808, 8), toPos = Position(32908, 31823, 8)} -- see image in thread for explanation

local exit_position = Position(32874, 31814, 8) -- Position completely outside the quest area
