...
['first afflicted addon'] = {cost = 0, items = {{13926,1}}, outfit_female = 431, outfit_male = 430, addon = 1, storageID = 10052},
['second afflicted addon'] = {cost = 0, items = {{13925,10}}, outfit_female = 431, outfit_male = 430, addon = 2, storageID = 10053}
...
local o = {'citizen', 'hunter', 'knight', 'mage', 'nobleman', 'summoner', 'warrior', 'barbarian', 'druid', 'wizard', 'oriental', 'pirate', 'assassin', 'beggar', 'shaman', 'norseman', 'afflicted'}
